...
Susanna Lehto. Teoriasta käytäntöön pilvipalvelimen avulla (h4): https://susannalehto.fi/2022/teoriasta-kaytantoon-pilvipalvelimen-avulla-h4/
...
AWS. How do I add new user AWS accounts with SSH access to my Amazon EC2 Linux instance?: https://repost.aws/knowledge-center/new-user-accounts-linux-instance
...
geeksforgeeks. How to Set File Permissions in Linux: https://www.geeksforgeeks.org/set-file-permissions-linux/
